...
public class TruliaTest {
	...
	public void tC004() {
		...
		home.searchButtonExist();
		home.searchBox.clear();
		home.searchBox.sendKeys(Config.getProperty("tc4val"));
		Browser.sleep(2);
		home.printSearchSuggestions();
	...
	@Test(priority = 12) //Requirements not matched
	public void tc011() {
		driver.get(Config.getProperty("url"));
	...
	@Test(priority = 13) //Requirements Not Matched
	public void tc012() {
		driver.get(Config.getProperty("url"));
